...
# Generated: Thu Dec  7 01:09:54 2017
##################################################
...
class fsat_grs_telemetry(grc_wxgui.top_block_gui):
    ...
    def __init__(self, sdr_dev="rtl=1", frequency="437.9e6", baud_rate="2.4e3", filter_bandwidth="50e3", sample_rate="1e6"):
...
def main(top_block_cls=fsat_grs_telemetry, sdr="rtl=1", freq="437.9e6", baud="2.4e3", band="50e3", sample="1e6"):
