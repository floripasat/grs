...
# Generated: Wed Oct 25 18:08:23 2017
##################################################
...
class fsat_grs_telemetry(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.GridAdd(_signal_source_freq_sizer, 1, 0, 1, 1)
        ...
        self.GridAdd(self._baudrate_text_box, 0, 1, 1, 1)
        ...
        self.GridAdd(self._bandwidth_text_box, 1, 1, 1, 1)
        ...
        self.GridAdd(self.wxgui_waterfallsink2_0.win, 2, 1, 1, 1)
