...
"""
ControlMainWindow: main control class. It initialize the other control classes.
SetupsMainwindow buttons, icons, menu actions and shortcuts. Window functions are defined here (eg. toggle fullscreen).
"""
